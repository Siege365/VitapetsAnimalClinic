...
<body>
                ...
                <div class="nav-row">
                   <div class="navButtons">
                        <ul>
                            ...
                            <li><a href="../html/aboutUs.php" class="about-link" style="color:#FFBE28;">About Us</a></li>
    ...
    <section class="aboutus">
        <div class="about_us">
            <h1>About Us</h1>
            <p>VitaPets Animal Clinic and Pet Supplies has proudly cared for pets and their families in
                <br>Davao City for over 5 years. As a family-owned and operated practice, we're dedicated 
                <br>to providing the highest quality care for your furbabies because they’re family too.
                <br>
                <br>
                At VitaPets Animal Clinic, we’re passionate about your pet’s health and happiness. 
                <br>From routine check-ups to advanced care, we proudly serve Davao City and 
                <br>nearby areas with a full range of veterinary services.
            </p>
        </div>
    </section>
        ...
        <div class="Services-Container">
            <div class="Services-Container1">
                <div class="paragraph1">
                    <h1>We're a fully serviced vet clinic with the latest technology.</h1>
                </div>
                <div class="paragraph2">
                    <h2>VitaPets Animal Clinic is committed to offering a wide range of services to our clients:</h2>
                </div>
                <div class="tagilid">
            ...
            <div class="Services-Container2">
                <div class="oath">
                    <input type="checkbox" id="oath-toggle" class="toggle">
                    <label for="oath-toggle">Our Oath</label>
                    <div class="oath-content">
                        <img src="../img/oath.png" alt="Oath Image">
                    </div>
                </div>
                <div class="clinicHours">
                    <input type="checkbox" id="clinicHours" class="Ctoggle">
                    <label for="clinicHours">Clinic Hours</label>
                    <div class="clinichours-content">
                        <img src="../img/ClinicHours.png" alt="ClinicHours Image">
                    </div>
                </div>
                <div class="right"><img src="../img/Right.png" alt="">
                    <button class = "book"onclick="location.href='../html/BookSchedule.php'">Book Schedule</button>
                </div>
            </div>
        </div>
    </section>
